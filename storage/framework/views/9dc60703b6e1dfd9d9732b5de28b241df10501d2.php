...
<?php $__env->startSection('content'); ?>
    ...
    <div class="h-section story">
        <div class="col-lg-12" id="h-introframe" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.1)),<?php echo e(url('/images/portrait3.png')); ?>;">
            <div class="h-text-intro" >
                <h2>WOMEN OF SAFE CITY</h2>
            </div>
            <nav class="header-nav">
                <a href="<?php echo e(url('stories')); ?>" class="stories-header" id="id-stories-header">
                    Stories
                </a>
