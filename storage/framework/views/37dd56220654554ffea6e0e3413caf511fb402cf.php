...
<?php $__env->startSection('content'); ?>
    <link rel="stylesheet" href="<?php echo e(url('css/Story.css')); ?>">
    <div class="h-section story">
        <div class="col-lg-12" id="h-introframe" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.1)),<?php echo e(url('../images/portrait1.png')); ?>">
            ...
            <nav class="header-nav">
                ...
                <a href="<?php echo e(url('heroes')); ?>" class="heroes-header" id="id-heroes-header">
                    Heroes
                </a>
                <span class="nav-spacer"></span>
                <a href="<?php echo e(url('witness')); ?>" class="witness-header" id="id-witness-header">
                    Witness
                </a>
            </nav>
        ...
        <div class="col-lg-12 infs" id="infs">
            <div class="row">
                <div class="col-lg-4 card border-0 inf">
                    <img src="<?php echo e(asset('images/portrait3.jpg')); ?>" class="card-img-top">
                    <div class="card-body">
                ...
                <div class="col-lg-4 card border-0  inf">
                    <img src="<?php echo e(asset('images/portrait4.jpg')); ?>" class="card-img-top">
                    <div class="card-body">
        ...
        <div class="col-lg-12 infs" id="infs">
            <div class="row">
                <div class="col-lg-4 card border-0 inf">
                    <img src="<?php echo e(asset('images/portrait15.jpg')); ?>" class="card-img-top">
                    <div class="card-body">
                ...
                <div class="col-lg-4 card border-0  inf">
                    <img src="<?php echo e(asset('images/portrait16.jpg')); ?>" class="card-img-top">
                    <div class="card-body">
                ...
                <div class="col-lg-4 card border-0  inf">
                    <img src="<?php echo e(asset('images/portrait17.jpg')); ?>" class="card-img-top">
                    <div class="card-body">
        ...
        <div class="bigframe">
            <div class="row">
                ...
                <div class="col-lg-8 frameform" style="background-image: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),<?php echo e(url('images/stories5.jpg')); ?>;">
