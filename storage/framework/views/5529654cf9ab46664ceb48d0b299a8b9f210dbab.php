...
<?php $__env->startSection('content'); ?>
    ...
    <div class="s-section div-event1">
        <div class="container">
            <div class="col-md-5 img">
                <img src="<?php echo e(asset('images/event-12.jpg')); ?>">
            </div>
            <div class="col-md-7 status">
                <h1><a href="<?php echo e(url('events')); ?>" class="event-2">Events</a> - <a href="#" class="campaign-2">Campaigns</a></h1>
    ...
    <div class="s-section div-event2">
        <div class="container">
            ...
            <div class="col-md-4 about-event">
                <div class="event-pics">
                    <img src="<?php echo e('images/event-3.jpg'); ?>">
                    <div class="e-event-mask">
                        <a href=""><h4>Campaign Name</h4></a>
                        <p>Place</p>
                        <span>Date</span>
            ...
            <div class="col-md-4 about-event">
                <div class="event-pics">
                    <img src="<?php echo e('images/event-4.jpg'); ?>">
                    <div class="e-event-mask">
                        <a href=""><h4>Campaign Name</h4></a>
                        <p>Place</p>
                        <span>Date</span>
            ...
            <div class="col-md-4 about-event">
                <div class="event-pics">
                    <img src="<?php echo e('images/event-5.jpg'); ?>">
                    <div class="e-event-mask">
                        <a href=""><h4>Campaign Name</h4></a>
                        <p>Place</p>
                        <span>Date</span>
